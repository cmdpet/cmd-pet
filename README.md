...
### How do I run it?
Open up CMD, and type ```pip install pyfiglet```. After it has finished, type ```cd [insert where it is, for example Downloads]``` and press enter. Then, type ```py -3 GameManager.py``` and press enter.
